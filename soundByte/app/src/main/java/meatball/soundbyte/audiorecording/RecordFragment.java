...
import meatball.soundbyte.AppConstants;
import meatball.soundbyte.R;
import meatball.soundbyte.activities.PlayListActivity;
import meatball.soundbyte.activities.SettingsActivity;
import meatball.soundbyte.audiovisualization.GLAudioVisualizationView;
import meatball.soundbyte.di.qualifiers.ActivityContext;
import meatball.soundbyte.mvpbase.BaseFragment;
import meatball.soundbyte.recordingservice.AudioRecordService;
import meatball.soundbyte.recordingservice.AudioRecorder;
import meatball.soundbyte.theme.ThemeHelper;
